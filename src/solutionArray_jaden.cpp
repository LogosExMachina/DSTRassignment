...
int main() {
    ...
    DataTable transTable = parser.parseCSV("data/transactions_cleaned.csv", transTypes, transStrLens, 6, 100);
    ...
    DataTable reviewTable = parser.parseCSV("data/reviews_cleaned.csv", revTypes, revStrLens, 4, 100);
